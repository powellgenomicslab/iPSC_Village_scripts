...
SCT <- readRDS(paste0(datadir, rep, "_cluster", cluster,"_SCT_seurat_1pct.rds"))
...
if (number <= nrow(SCT[["SCT"]]@counts)){
	...
	saveRDS(variance_partition, paste0(outdir, rep, "_cluster", cluster,"_", gene, "_variable_variance_partition_coefficients.rds"))
