...
RSCRIPT="$DIR/scripts/EdgeR/EdgeR.R"
...
echo "The R script being used is: $RSCRIPT"
...
/share/ClusterShare/software/contrib/sccg/miniconda3/envs/EdgeR/bin/Rscript $RSCRIPT $ARGS/arguments$stage$today.$SGE_TASK_ID.txt