...
for i in range(0,12):
	...
	# adata_sep[i].layers.X = csr_matrix(Mb[i].T)
...
outdir="/directflow/SCCGGroupShare/projects/DrewNeavin/iPSC_Village/output/scVelo/velocyto/scvelo_combat_corrected/"
os.chdir(outdir)
...
for i in range(0,12):
	...
	scv.pl.velocity_embedding(adata_sep[i], basis='umap', arrow_length=3, arrow_size=5, dpi=150, color=['clusters'], save= name + "_arrow.png")
