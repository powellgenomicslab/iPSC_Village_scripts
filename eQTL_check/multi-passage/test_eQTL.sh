...
SNAKEFILE="/directflow/SCCGGroupShare/projects/DrewNeavin/iPSC_Village/scripts/eQTL_check/multi-passage/test_eQTL.smk"
LOG="/directflow/SCCGGroupShare/projects/DrewNeavin/iPSC_Village/output//multi-passage/deboever/gene_separate/logs/"
