...
OUTDIR="$DIR/cryopreserved/uniculture"

mkdir -p $OUTDIR

deboever_genes="$DIR/deboever_gene_snp_list.tsv"
variance_genes="/directflow/SCCGGroupShare/projects/DrewNeavin/iPSC_Village/output/variance_partition_post_review_cryo2/uniculture/gene_separated/residuals4qtl"
