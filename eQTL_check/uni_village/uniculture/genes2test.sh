...
variance_genes="/directflow/SCCGGroupShare/projects/DrewNeavin/iPSC_Village/output/variance_partition_post_review2/uniculture/gene_separated/residuals4qtl"
